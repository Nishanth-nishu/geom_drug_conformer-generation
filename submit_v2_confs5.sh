#!/bin/bash
#SBATCH --job-name=v2_confs5
#SBATCH --output=/scratch/nishanth.r/nextmol_experiment/mol_expermiments/logs/v2_confs5_%j.log
#SBATCH --error=/scratch/nishanth.r/nextmol_experiment/mol_expermiments/logs/v2_confs5_%j.log
#SBATCH --nodes=1
...
# ─────────────────────────────────────────────────────────────────────────────
# Conformer Ablation: 5 conformers/molecule
#
...
# Conformers    : TOP-5 by Boltzmann weight
#
# Compare against submit_v2_confs10.sh (10 conformers) to measure
...
MAX_ATOMS=30
MAX_MOLS=50000
MAX_CONFS=5           # ← KEY: 5 conformers per molecule
MIN_CONFS=2
HIDDEN_DIM=256
...
EXP_NAME="v2_dual_confs5_T5000_atoms${MAX_ATOMS}_mols${MAX_MOLS}"
...
echo "Conformers  : $MAX_CONFS (TOP-5 by Boltzmann weight)"
...
echo "============================================================"
echo "Full training: $EPOCHS epochs | 5 conformers/mol | T=$NUM_TIMESTEPS"
echo "============================================================"
